...
from homeassistant.const import (ENERGY_KILO_WATT_HOUR, POWER_WATT, POWER_KILO_WATT,
                                 ...
                                 FREQUENCY_HERTZ, TEMP_CELSIUS, DEVICE_CLASS_TEMPERATURE)
...
SENSOR_DESCRIPTIONS: tuple[KostalPikoSensorEntityDescription, ...] = (
    ...
    KostalPikoSensorEntityDescription(
        description=SensorEntityDescription(
            key="kostal_piko_battery_charge_level",
            name="Kostal PIKO Battery Charge Level",
    ...
    KostalPikoSensorEntityDescription(
        description=SensorEntityDescription(
            key="kostal_piko_battery_current",
            name="Kostal PIKO Battery Current",
            device_class=SensorDeviceClass.CURRENT,
            state_class=SensorStateClass.MEASUREMENT,
            native_unit_of_measurement=ELECTRIC_CURRENT_AMPERE,
            icon="mdi:current-dc"),
    ...
    # Battery Absolute Current
    KostalPikoSensorEntityDescription(
        description=SensorEntityDescription(
            key="kostal_piko_battery_absolute_current",
            name="Kostal PIKO Battery Absolute Current",
            device_class=SensorDeviceClass.CURRENT,
            state_class=SensorStateClass.MEASUREMENT,
            native_unit_of_measurement=ELECTRIC_CURRENT_AMPERE,
            icon="mdi:current-dc"),
    ...
    KostalPikoSensorEntityDescription(
        description=SensorEntityDescription(
            key="kostal_piko_battery_voltage",
            name="Kostal PIKO Battery Voltage",
            device_class=SensorDeviceClass.VOLTAGE,
            state_class=SensorStateClass.MEASUREMENT,
            native_unit_of_measurement=ELECTRIC_POTENTIAL_VOLT,
            icon="mdi:power-plug"),
    ...
    KostalPikoSensorEntityDescription(
        description=SensorEntityDescription(
            key="kostal_piko_battery_temperature",
            name="Kostal PIKO Battery Temperature",
